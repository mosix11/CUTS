...
class KMNIST(BaseClassificationDataset):
    ...
    def load_train_set(self):
        ...
        trainset = datasets.KMNIST(root=self.dataset_dir, train=True, transform=self.train_transforms, download=True)
    ...
    def load_test_set(self):
        ...
        return datasets.KMNIST(root=self.dataset_dir, train=False, transform=self.val_transforms, download=True)
