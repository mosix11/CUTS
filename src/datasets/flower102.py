...
class Flowers102(BaseClassificationDataset):
    ...
    def load_train_set(self):
        return datasets.Flowers102(root=self.dataset_dir, train=True, transform=self.get_transforms(train=True), download=True)
    
    def load_validation_set(self):
        return None
    
    def load_test_set(self):
        return datasets.Flowers102(root=self.dataset_dir, train=False, transform=self.get_transforms(train=False), download=True)
